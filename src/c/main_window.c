...
void menu_draw_header_callback(GContext* ctx, const Layer *cell_layer, uint16_t section_index, void *data) {
	switch(section_index){
		case 0: 
			menu_cell_basic_header_draw(ctx, cell_layer, "Teams");
			break;
		case 1: 
    ...
    switch(cell_index->section){
		case 0:
			switch(cell_index->row){
				case 0:
					menu_cell_basic_draw(ctx, cell_layer, "Arsenal", "39 pts", NULL);
					break;
			}
			break;
		case 1:
			menu_cell_basic_draw(ctx, cell_layer, "Add team", NULL, NULL);
			break;
	}
}
